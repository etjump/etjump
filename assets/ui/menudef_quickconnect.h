...
// 2 edges, 3 gaps between buttons
#define QUICK_CONNECT_BTN_W ( (QUICK_CONNECT_RECT_W - (QUICK_CONNECT_BTN_MARGIN_X * 2) - (QUICK_CONNECT_BTN_MARGIN_X * 3)) / 4 )
#define QUICK_CONNECT_BTN_H 12

#define QUICK_CONNECT_BTN_JOIN_POS(pos) QUICK_CONNECT_RECT_X + QUICK_CONNECT_BTN_MARGIN_X, QUICK_CONNECT_BTN_Y(pos), QUICK_CONNECT_BTN_W, QUICK_CONNECT_BTN_H
#define QUICK_CONNECT_BTN_INFO_POS(pos) QUICK_CONNECT_RECT_X + (QUICK_CONNECT_BTN_MARGIN_X * 2) + QUICK_CONNECT_BTN_W, QUICK_CONNECT_BTN_Y(pos), QUICK_CONNECT_BTN_W, QUICK_CONNECT_BTN_H
#define QUICK_CONNECT_BTN_EDIT_POS(pos) QUICK_CONNECT_RECT_X + (QUICK_CONNECT_BTN_MARGIN_X * 3) + (QUICK_CONNECT_BTN_W * 2), QUICK_CONNECT_BTN_Y(pos), QUICK_CONNECT_BTN_W, QUICK_CONNECT_BTN_H
#define QUICK_CONNECT_BTN_DELETE_POS(pos) QUICK_CONNECT_RECT_X + (QUICK_CONNECT_BTN_MARGIN_X * 4) + (QUICK_CONNECT_BTN_W * 3), QUICK_CONNECT_BTN_Y(pos), QUICK_CONNECT_BTN_W, QUICK_CONNECT_BTN_H
