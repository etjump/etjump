    ...
    foreach(line ${CONTENTS})
        ...
        if(line MATCHES "^# +")
            ...
            if(SECTION_NAME AND SECTION_CONTENT)
                ...
                file(WRITE "${CMAKE_CURRENT_SOURCE_DIR}/assets/ui/changelog/${FILENAME}.txt" ${SECTION_NAME} ${SECTION_CONTENT})
