...
typedef struct
{
	Rectangle_t rect;                 // client coord rectangle
	Rectangle_t rectClient;           // screen coord rectangle
	const char *name;               //
	const char *model;              //
	...
	Rectangle_t rectEffects;          // for various effects
	Rectangle_t rectEffects2;         // for various effects
...
typedef struct itemDef_s
{
	...
	Rectangle_t textRect;             // rectangle the text ( if any ) consumes
