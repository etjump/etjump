...
//    {"deleteuser", "!deleteuser -id [user id]", "Deletes a user based on ID."},
	...
	{ "finger",       "!finger [target]",                                                                                                                                                               "Displays targets admin level."                                                      },
...
//    { "routemaker", "!routemaker [player]", "Makes target player the route maker." },
	{ "rmsaves",      "!rmsaves [target]",                                                                                                                                                              "Clears targets saved positions."                                                    },
	{ "setlevel",     "!setlevel [target] [level]\n!setlevel -id [id] [level]",                                                                                                                         "Sets the targets admin level."                                                      },
