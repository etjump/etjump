  ...
  while (1) {
    ...
    if (!Q_stricmp(token.string, "mesh")) {
      ...
      if (!PC_String_ParseNoAlloc(handle, characterDef->animationScript,
        ...
        return BG_PCF_ParseError(handle, "expected animationScript "
                                         "filename");
      }
      ...
      if (!PC_String_ParseNoAlloc(handle, characterDef->undressedCorpseModel,
        ...
        return BG_PCF_ParseError(handle, "expected undressedCorpseModel "
                                         "filename");
      }
      ...
      if (!PC_String_ParseNoAlloc(handle, characterDef->undressedCorpseSkin,
        ...
        return BG_PCF_ParseError(handle, "expected undressedCorpseSkin "
                                         "filename");
      }
