...
vec4_t clrBrownTextLt2 = { 108.f * 1.8f / 255.f, 88.f * 1.8f / 255.f, 62.f * 1.8f / 255.f, 1.f };
vec4_t clrBrownTextLt = { 108.f * 1.3f / 255.f, 88.f * 1.3f / 255.f, 62.f * 1.3f / 255.f, 1.f };
vec4_t clrBrownText = { 108 / 255.f, 88 / 255.f, 62 / 255.f, 1.f };
vec4_t clrBrownTextDk = { 20 / 255.f, 2 / 255.f, 0 / 255.f, 1.f };
vec4_t clrBrownTextDk2 = { 108.f * 0.75f / 255.f, 88.f * 0.75f / 255.f, 62.f * 0.75f / 255.f, 1.f };
