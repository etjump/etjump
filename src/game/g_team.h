...
#define CTF_TARGET_PROTECT_RADIUS                                              \
  400 // the radius around an object being defended where a target will
      // be worth extra frags

/*#define CTF_CAPTURE_BONUS		5		// what you get for
capture #define CTF_TEAM_BONUS			0		// what your
team gets for capture
#define CTF_RECOVERY_BONUS		1		// what you get for
recovery #define CTF_FLAG_BONUS			0		// what you get
for picking up enemy flag
#define CTF_FRAG_CARRIER_BONUS	2		// what you get for fragging
enemy flag carrier #define CTF_FLAG_RETURN_TIME	40000	// seconds until auto
return
...
grapple in flight
#define CTF_GRAPPLE_PULL_SPEED				750	// speed player
is pulled at*/
