...
constexpr int CONTENTS_NOSHOVE      = 0x00001000; // etjump, surfaceparm "ai_nosight"
...
constexpr int CONTENTS_NOPRONE      = 0x00200000; // etjump, was DONOTENTER, surfaceparm "donotenter"
