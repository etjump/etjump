...
#define ANIM_SPEEDMAX_HIGH 20
  ...
  if (cent->currentState.eFlags & EF_FORCE_END_FRAME
      // xkan, 12/27/2002 - In SP, corpse also stays at the last frame
      // (of the death animation) so that the death animation can end up
      // in different positions and the body will stay in that position
