...
void CG_EDV_RunInput(void)
{
	...
	if (cg.snap->ps.persistant[PERS_HWEAPON_USE] && cgs.demoCam.renderingFreeCam)
	{
	...
	cg.refdefViewAngles[YAW] += (cgs.demoCam.turn & 0x01) ? etj_demo_yawturnspeed.value * frametime : 0;
