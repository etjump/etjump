...
//		CG_Trace( &tr, start, NULL, NULL, traceEnd, -1, MASK_ALL &~(CONTENTS_MONSTERCLIP|CONTENTS_AREAPORTAL|CONTENTS_NOSAVE));
	}
...
//
	...
	if (!(flags & SL_NOFLARE))
	{
		...
		{
			CG_Trace(&tr, start, NULL, NULL, camloc, -1, MASK_ALL & ~(CONTENTS_MONSTERCLIP | CONTENTS_AREAPORTAL | CONTENTS_NOSAVE));
			if (tr.fraction != 1)
			{
				lightInEyes = qfalse;
			}
